export namespace EXIF {
    ...
    export namespace StringValues {
        ...
        export const SubjectDistanceRange: {
            0: string;
            1: string;
            2: string;
            3: string;
    ...
    export function getData(img: any, callback: any): boolean;
    export function getTag(img: any, tag: any): any;
    export function getIptcTag(img: any, tag: any): any;
    export function getAllTags(img: any): {};
    export function getAllIptcTags(img: any): {};
