...
var EXIF = function (obj) {
    if (obj instanceof exports.EXIF)
        return obj;
    if (!(this instanceof exports.EXIF))
        return new exports.EXIF(obj);
    this.EXIFwrapped = obj;
};
var ExifTags = exports.EXIF.Tags = {
    // version tags
    0x9000: "ExifVersion",
...
var TiffTags = exports.EXIF.TiffTags = {
    0x0100: "ImageWidth",
    0x0101: "ImageHeight",
...
var GPSTags = exports.EXIF.GPSTags = {
    0x0000: "GPSVersionID",
...
// EXIF 2.3 Spec
var IFD1Tags = exports.EXIF.IFD1Tags = {
    0x0100: "ImageWidth",
    0x0101: "ImageHeight",
    0x0102: "BitsPerSample",
    0x0103: "Compression",
...
var StringValues = exports.EXIF.StringValues = {
    ExposureProgram: {
        0: "Not defined",
        1: "Manual",
        2: "Normal program",
...
exports.EXIF.enableXmp = function () {
    exports.EXIF.isXmpEnabled = true;
};
exports.EXIF.disableXmp = function () {
    exports.EXIF.isXmpEnabled = false;
};
exports.EXIF.getData = function (img, callback) {
...
exports.EXIF.getTag = function (img, tag) {
    if (!imageHasData(img))
        return;
    return img.exifdata[tag];
};
exports.EXIF.getIptcTag = function (img, tag) {
    if (!imageHasData(img))
        return;
    return img.iptcdata[tag];
};
exports.EXIF.getAllTags = function (img) {
    if (!imageHasData(img))
        return {};
...
exports.EXIF.getAllIptcTags = function (img) {
    if (!imageHasData(img))
        return {};
...
exports.EXIF.pretty = function (img) {
    if (!imageHasData(img))
        return "";
...
exports.EXIF.readFromBinaryFile = function (file) {
